...
const weeklyWorkouts = workoutsForUser.filter(workout => moment(workout.createdat).format('YYYY') === moment().format('YYYY') && moment(workout.createdat).isoWeek() === moment().isoWeek());
